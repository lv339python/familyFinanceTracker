...
from spending.views import set_spending_limitation_ind, show_spending_ind, group_limit, set_group_limit, change_group_limit, test

urlpatterns = [
  re_path(r'^$', show_spending_ind),
  re_path(r'^set_limit/', set_spending_limitation_ind),
  path('admin/limit/', group_limit),
  path('admin/limit/<int:user_id>/', group_limit),

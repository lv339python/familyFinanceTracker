...
import {Login,Spending_registration, Spend, Limit, Icon_getter, Spending_add, Financial_goal, Funds_registration, Goal, Spending_history,GoalTable} from "src/components";
...
export default [
    ...
    {
        path: '/goaltable', component: GoalTable
    },
